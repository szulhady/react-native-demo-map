  ...
  useEffect(() => {
	...
	return (
		<Layout navigation={navigation} name="Home">
            ...
            style={{width:'99%',height:100, backgroundColor:'#19A78B', justifyContent:'flex-start', paddingTop:10, paddingLeft:15, borderRadius:10}}
            >
            <View style={{width:"65%",  }}>
              <Text bold style={{color:'#faf3f2', fontSize:16, paddingBottom:5,letterSpacing:2,}}>BALAI BOMBA DAN PENYELAMAT SRI HARTAMAS</Text>
            </View>
            <View style={{width: "65%"}}>
              <Text style={{ fontSize:22, color:"red",fontWeight:"bold", textShadowColor:'black',
    textShadowOffset:{width:2, height:1},
    textShadowRadius:2, letterSpacing: 5, }}>FLASH MODULAR DETECTOR</Text>
            </View>
            {/* <Image
                style={{width: 150,
              ...
              /> */}
                    <Image
        style={{height:110, width:110, position:"absolute", right:5, top:-5}}
